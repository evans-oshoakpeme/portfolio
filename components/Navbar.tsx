  ...
  return (
    <nav className="sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-navbar-background rounded-full px-24 w-258.5 h-18 flex justify-around items-center">
          {/* Desktop Navigation Links */}
          {/* hidden by default (mobile), md:flex renders it on medium devices and up */}
          <div className="hidden md:flex justify-between items-center space-x-32 text-xs font-medium">
            <Link href="/" className="text-foreground hover:text-gray-900 dark:text-foreground dark:hover:text-white">
              HOME
            </Link>
            <Link href="/work" className="text-foreground hover:text-gray-900 dark:text-foreground dark:hover:text-white">
              WORK
            </Link>
